...
def cell_style0(ws0,len_index0,week0,names):
	width_dict={'A':7.5,'B':11,'C':6,'D':15.3,'E':25,'F':15,'G':11,'H':11,'I':20,'J':5,'K':5}
...
def wash_data(filename):
	wb = Workbook()
	data = pd.read_excel(filename, sheet_name='Sheet0',usecols=[4,6,7,9,11,14,17,18,20,21,22,25,29])#读取表
	...
	if data.学期.iloc[1] == '春季班' or data.学期.iloc[1] == '秋季班'or data.学期.iloc[1]== '短期班':
